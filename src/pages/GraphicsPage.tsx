...
export function GraphicsPage() {
  ...
  async function createProductionDay() {
    try {
      ...
      const dateWithTimezone = new Date(selectedDateObj.getTime() + (24 + 3) * 60 * 60 * 1000);
      const formattedDate = format(dateWithTimezone, 'yyyy-MM-dd');
        ...
        <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center">
          <div className="bg-white rounded-lg p-6 max-w-sm w-full">
            ...
            <div className="mb-4">
              ...
              />
              <p className="mt-1 text-sm text-gray-500">
                O dia de produção será criado para a data selecionada.
              </p>
            </div>
